...
Tags: appearance, conditional, control, customize, display, hide, logic, placement, show, view, visibility, widget, widgets
Requires at least: 4.0
Tested up to: 4.1.1
Stable tag: 1.0.0
License: GPLv3

A Widget toolbox that adds visibility management and helps to control where widgets are shown efficiently.

== Description ==

Widgets Control is a toolbox that features visibility management for every widget.
It allows to show widgets based on conditions -
you can choose to show widgets only on certain pages or
exclude widgets from being displayed.

For each widget, you can decide where it should be displayed:

- show a widget on all pages
